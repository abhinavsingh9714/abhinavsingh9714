...
/** Mock assistant response and citations for a question (used before SSE is connected) */
export function getMockResponse(question: string): { content: string; citations: Citation[] } {
  ...
  if (lower.includes('experience') || lower.includes('ml experience') || lower.includes('genai') || lower.includes('summarize')) {
    return {
  ...
  if (lower.includes('project') || lower.includes('jira') || lower.includes('rag') || lower.includes('portfolio')) {
    return {
  ...
  if (lower.includes('skill') || lower.includes('framework') || lower.includes('stack') || lower.includes('cloud') || lower.includes('mlops')) {
    return {
  ...
  if (lower.includes('education') || lower.includes('thesis') || lower.includes('study') || lower.includes('courses')) {
    return {
  ...
  return {
    content: "Here's a summary based on Abhinav's resume. Ask about experience, projects, skills, or education for more detail.",
